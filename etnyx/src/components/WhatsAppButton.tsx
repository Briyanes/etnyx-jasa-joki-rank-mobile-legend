...
export default function WhatsAppButton() {
  ...
  const t = {
    id: {
      tooltip: "Klik Hubungi Admin Sekarang",
      message: "Halo kak, saya mau tanya tentang jasa joki ETNYX",
    },
    en: {
      tooltip: "Click to Contact Admin Now",
      message: "Hi, I want to ask about ETNYX boosting service",
    },
  };
  ...
  return (
    <div
      className={`fixed bottom-6 right-4 md:right-6 z-40 transition-all duration-500 ${
    ...
    >
      ...
      >
        <div className="bg-surface text-text px-4 py-2 rounded-xl shadow-lg border border-white/10 whitespace-nowrap text-sm font-medium">
          {txt.tooltip}
          <div className="absolute left-full top-1/2 -translate-y-1/2 -ml-1">
            <div className="border-8 border-transparent border-l-surface" />
          </div>
        </div>
      </div>
      ...
      >
        {/* Pulse ring */}
        <span className="absolute inset-[6px] rounded-full bg-[#25D366] animate-ping opacity-20" />
