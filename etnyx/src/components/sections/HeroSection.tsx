...
export default function HeroSection() {
  ...
  const content = {
    ...
    en: {
      ...
      headline1: cms?.headline?.split(",")[0]?.trim() || "Push Rank,",
      headline2: cms?.headline?.split(",").slice(1).join(",")?.trim() || "Without Playing.",
      subtitle: cms?.subheadline || "Trusted ML boosting service. Pick your rank, order, sit back — our boosters do the work.",
      cta1: cms?.ctaPrimary || "Order Now",
      cta2: cms?.ctaSecondary || "Track Order",
