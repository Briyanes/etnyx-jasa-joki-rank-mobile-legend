  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Untuk pembayaran melalui Duitku (VA, QRIS, E-Wallet), refund akan ditransfer ke rekening bank yang didaftarkan pelanggan.",
      ],
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "For payments via Duitku (VA, QRIS, E-Wallet), refunds will be transferred to the customer's registered bank account.",
      ],
    },
    {
