...
const faqId = {
  ...
  items: [
    ...
    },
    {
      ...
      a: "Kami menerima pembayaran via Transfer Bank (BCA, BRI, BNI, Mandiri, Jago), E-Wallet, QRIS, dan pembayaran otomatis melalui Duitku (Virtual Account, GoPay, ShopeePay, Kartu Kredit).",
    },
    {
    ...
    },
    {
      ...
      a: "Ya, pembayaran otomatis diproses melalui Duitku, payment gateway resmi yang terdaftar di Bank Indonesia. Data pembayaran tidak disimpan di server kami.",
    },
    {
...
const faqEn = {
  ...
  items: [
    ...
    },
    {
      ...
      a: "We accept payment via Bank Transfer (BCA, BRI, BNI, Mandiri, Jago), E-Wallet, QRIS, and automatic payment through Duitku (Virtual Account, GoPay, ShopeePay, Credit Card).",
    },
    {
    ...
    },
    {
      ...
      a: "Yes, automatic payments are processed through Duitku, an official payment gateway registered with Bank Indonesia. Payment data is not stored on our servers.",
    },
    {
