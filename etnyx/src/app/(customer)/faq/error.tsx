  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-xl font-semibold text-text mb-2">Gagal Memuat FAQ</h1>
        <p className="text-text-muted text-sm mb-2">Maaf, terjadi kesalahan saat memuat halaman FAQ.</p>
        {error.digest && (
