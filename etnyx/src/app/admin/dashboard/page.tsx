                        ...
                        <tr key={o.id} className={`border-b border-white/5 hover:bg-white/[0.02] transition-colors ${selectedOrders.has(o.id) ? "bg-accent/5" : ""}`}>
                          ...
                          <td className="px-4 py-3">
                            ...
                            {o.payment_method === "manual_transfer" ? (
                              ...
                              <span className="inline-block mt-1.5 px-1.5 py-0.5 rounded text-[9px] font-medium bg-blue-500/10 text-blue-400 border border-blue-500/20">Duitku</span>
                            )}
                          </td>
                          <td className="px-4 py-3">
                            <select
                              ...
                              {o.status === "pending" && (<>
                                ...
                                {o.payment_method !== "manual_transfer" && (
                                  <span className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-[10px] font-medium bg-blue-500/10 text-blue-400 w-full">
                                    <Clock className="w-3 h-3" /> Menunggu pembayaran Duitku
                                  </span>
                                )}
