...
INSERT INTO orders (id, order_id, username, game_id, whatsapp, current_rank, target_rank, package, is_express, is_premium, base_price, total_price, status, progress, customer_id, assigned_worker_id, booster_id, created_at, confirmed_at, payment_status, paid_at) VALUES
  ...
  -- PERSTAR: Mythic Grading 3 match (completed)
  ('d0000000-0000-0000-0000-000000000015', 'ETX-260314-001', 'MegaStar', '99998888 (7766)', '081400008888', 'mythicgrading', 'mythicgrading', 'Per Star Mythic Grading × 3 match', false, false, 60000, 60000, 'completed', 100, 'c0000000-0000-0000-0000-000000000008', 'a0000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000001', NOW() - INTERVAL '17 days', NOW() - INTERVAL '17 days', 'paid', NOW() - INTERVAL '17 days'),
...
INSERT INTO orders (id, order_id, username, game_id, whatsapp, current_rank, target_rank, package, is_express, is_premium, base_price, total_price, status, progress, customer_id, assigned_worker_id, booster_id, created_at, confirmed_at, payment_status, paid_at) VALUES
  ...
  -- GENDONG: Mythic Grading 3 match (completed)
  ('d0000000-0000-0000-0000-000000000025', 'ETX-260319-001', 'DianaQ', '44445555 (6677)', '081400006666', 'mythicgrading', 'mythicgrading', 'Gendong Mythic Grading × 3 match', false, false, 69000, 69000, 'completed', 100, 'c0000000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000001', NOW() - INTERVAL '11 days', NOW() - INTERVAL '11 days', 'paid', NOW() - INTERVAL '11 days'),
