...
const statusConfig: Record<string, { label: string; color: string; icon: string }> = {
  pending: { label: "Menunggu Konfirmasi", color: "text-yellow-400", icon: "⏳" },
  confirmed: { label: "Dikonfirmasi", color: "text-blue-400", icon: "✓" },
  in_progress: { label: "Sedang Dikerjakan", color: "text-accent", icon: "🚀" },
  completed: { label: "Selesai", color: "text-green-400", icon: "✅" },
  cancelled: { label: "Dibatalkan", color: "text-red-400", icon: "❌" },
};
