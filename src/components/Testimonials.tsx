...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-16 md:py-24 bg-surface/30">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted max-w-lg mx-auto">
            Review asli dari customer yang sudah menggunakan jasa ETNYX
          </p>
        </div>
        ...
        {testimonials.length > 3 && (
          <div className="text-center">
            ...
            >
              {showAll ? "Tampilkan Lebih Sedikit" : `Lihat ${testimonials.length - 3} Review Lainnya`}
            </button>
          </div>
        )}
        ...
        <div className="mt-12 grid grid-cols-3 gap-4 max-w-2xl mx-auto">
          <div className="text-center p-4 bg-surface rounded-xl">
            ...
            <p className="text-xs text-muted">Order Selesai</p>
          </div>
          <div className="text-center p-4 bg-surface rounded-xl">
          ...
          <div className="text-center p-4 bg-surface rounded-xl">
            ...
            <p className="text-xs text-muted">Aman</p>
          </div>
        </div>
      </div>
    </section>
